        ...
        <main id="homepage-container">
            ...
            <section id="locate">
                ...
                <div>
                    ...
                    <div className="btn-group">
                        <button className="btn-outline-dark btn-hover-color">
                            <svg id="map-pin-icon" className="icon" xmlns="http://www.w3.org/2000/svg" height="16" width="12" viewBox="0 0 384 512">
                        ...
                        <button className="btn-outline-dark btn-hover-color">
                            <svg id="help-question-mark-icon" className="icon" xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512">
